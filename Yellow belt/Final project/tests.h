...
void TestDatabase() {
    ...
    // Last
    {
        ...
        db.Add(d1, "e1");
        db.Add(d2, "e2");
        AssertEqual(db.Last(d), pair<Date,string>({2018, 12, 22}, "e2"), "Db Last 1");
        Date d3(2018, 12, 24);
        db.Add(d3, "e3");
        AssertEqual(db.Last(d), pair<Date,string>({2018, 12, 24}, "e3"), "Db Last 2");
        ...
        AssertEqual(db.Last(d), pair<Date,string>({2018, 12, 22}, "e2"), "Db Last 4");

        AssertEqual(db.Last(d1), pair<Date,string>({2019, 1, 2}, "e1"), "Db Last 5");
        db.Add(d2, "e4");
        AssertEqual(db.Last(d2), pair<Date,string>({2018, 12, 22}, "e4"), "Db Last 6");
    }
